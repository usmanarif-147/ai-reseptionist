...
ALTER TABLE public.widget_settings
  ADD COLUMN IF NOT EXISTS show_business_name boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS show_contact boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS show_address boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS show_business_type boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS show_business_hours boolean DEFAULT false,
  ...
  ADD COLUMN IF NOT EXISTS show_appointment_service boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS show_appointment_staff boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS show_appointment_datetime boolean DEFAULT false,
  ADD COLUMN IF NOT EXISTS show_appointment_duration boolean DEFAULT false,
  ...
  ADD COLUMN IF NOT EXISTS show_appointment_notes boolean DEFAULT false;
