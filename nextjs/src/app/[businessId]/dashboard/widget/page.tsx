...
export default function WidgetPage() {
  ...
  const [showAppointmentService, setShowAppointmentService] = useState(true)
  const [showAppointmentStaff, setShowAppointmentStaff] = useState(true)
  const [showAppointmentDatetime, setShowAppointmentDatetime] = useState(true)
  const [showAppointmentDuration, setShowAppointmentDuration] = useState(true)
  ...
  const [showAppointmentNotes, setShowAppointmentNotes] = useState(true)
  ...
  async function loadWidget() {
    ...
    if (widgetRes.ok) {
      ...
      if (data) {
        ...
        setShowBusinessName(data.show_business_name ?? true)
        setShowContact(data.show_contact ?? true)
        setShowAddress(data.show_address ?? true)
        setShowBusinessType(data.show_business_type ?? true)
        setShowBusinessHours(data.show_business_hours ?? true)
        ...
        setShowAppointmentService(data.show_appointment_service ?? true)
        setShowAppointmentStaff(data.show_appointment_staff ?? true)
        setShowAppointmentDatetime(data.show_appointment_datetime ?? true)
        setShowAppointmentDuration(data.show_appointment_duration ?? true)
        ...
        setShowAppointmentNotes(data.show_appointment_notes ?? true)
      }
    }
