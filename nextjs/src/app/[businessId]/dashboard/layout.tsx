...
const navItems = [
  { label: 'Overview', path: '', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0a1 1 0 01-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1' },
  ...
  { label: 'Business Hours', path: '/hours', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  { label: 'Widget', path: '/widget', icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4' },
